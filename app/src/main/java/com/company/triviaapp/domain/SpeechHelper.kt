...
// Created with the help of https://github.com/CuriousNikhil/gossip/blob/7771bdec6f157778080627a0eccef7b0bcf61256/gossip/src/main/java/me/nikhya/gossip/Gossip.kt
// A class which implements TextToSpeech.OnInitListener interface
class SpeechHelper(private val context: Context): TextToSpeech.OnInitListener {
    ...
    companion object {
        ...
        internal val TAG = SpeechHelper::class.java.simpleName
